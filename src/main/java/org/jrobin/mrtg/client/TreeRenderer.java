...
public class TreeRenderer extends DefaultTreeCellRenderer {
	...
	TreeRenderer() {
            MRTG_ICON = new ImageIcon(getClass().getResource("/pic/icons/mrtg.png"));
            ROUTER_ICON = new ImageIcon(getClass().getResource("/pic/icons/router.png"));
            LINK_ICON = new ImageIcon(getClass().getResource("/pic/icons/link.png"));
            INACTIVE_ROUTER_ICON = new ImageIcon(ColorIcon.colorize(ROUTER_ICON.getImage(), Color.red));
            INACTIVE_LINK_ICON = new ImageIcon(ColorIcon.colorize(LINK_ICON.getImage(), Color.red));            
            setLeafIcon(null);
            setClosedIcon(null);
